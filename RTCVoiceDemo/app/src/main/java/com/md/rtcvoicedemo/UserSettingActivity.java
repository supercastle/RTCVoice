...
public class UserSettingActivity extends Activity {
    ...
    private static final String TAG = "Terminal-Android";
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);
        ...
        us.UserId = sharedPreferences.getLong(UserSettingKey.UserIdKey, (long)136136);
                ...
                try {
                    ...
                    if (bWrite == true) {
                        ...
                        sharedPreferences.edit()
                                ...
                                .putLong(UserSettingKey.UserIdKey, Long.valueOf(et_UserId.getText().toString()))
                                .putInt(UserSettingKey.DomainIdKey, Integer.valueOf(et_DomainId.getText().toString()))
                                .putLong(UserSettingKey.RoomIdKey, Long.valueOf(et_RoomId.getText().toString()))
